...
char *const trap_type[] = {
	"mechanical", "magical", "unused1", "unused2", "unused3", "unused4",
	"unused5", "unused6"
};

char *const trap_damage_type[] = {
	"spike", "acid", "explosion", "crossbolt", "poison", "gas", "lightning",
	"razor", "shocker", "teleport", "mana", "gibberish", "sleeper"
